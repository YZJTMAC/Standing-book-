...
public class ProjectEntityQueryVo extends BaseQueryVo{

	/**
	 * 
	 */
	private static final long serialVersionUID = -1387495137907137462L;
     ...
     * 项目所在省份
     */
    private List<Integer> provincialList;
     ...
     * 到款单位名称
     */
    private List<String> collectMoneyCompanyList;
	...
	public List<Integer> getProvincialList() {
		return provincialList;
	}

	public void setProvincialList(List<Integer> provincialList) {
	...
	public List<String> getCollectMoneyCompanyList() {
		return collectMoneyCompanyList;
	}

	public void setCollectMoneyCompanyList(List<String> collectMoneyCompanyList) {
		this.collectMoneyCompanyList = collectMoneyCompanyList;
	}
